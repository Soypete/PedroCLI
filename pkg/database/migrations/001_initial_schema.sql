-- +goose Up
-- Initial database schema for PedroCLI
...
-- +goose Down
DROP INDEX IF EXISTS idx_repo_jobs_status;
DROP INDEX IF EXISTS idx_repo_jobs_repo_id;
DROP TABLE IF EXISTS repo_jobs;

DROP INDEX IF EXISTS idx_hook_runs_created_at;
DROP INDEX IF EXISTS idx_hook_runs_repo_id;
DROP TABLE IF EXISTS hook_runs;

DROP INDEX IF EXISTS idx_tracked_prs_status;
DROP INDEX IF EXISTS idx_tracked_prs_repo_id;
DROP TABLE IF EXISTS tracked_prs;

DROP INDEX IF EXISTS idx_repo_operations_created_at;
DROP INDEX IF EXISTS idx_repo_operations_repo_id;
DROP TABLE IF EXISTS repo_operations;

DROP TABLE IF EXISTS git_credentials;

DROP INDEX IF EXISTS idx_managed_repos_local_path;
DROP INDEX IF EXISTS idx_managed_repos_provider_owner;
DROP TABLE IF EXISTS managed_repos;
